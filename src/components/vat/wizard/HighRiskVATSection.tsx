    ...
    <div className="space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Review expenses in categories with special VAT rules
        </p>
      </div>
      ...
      <div className="space-y-3">
        <div className="flex items-start gap-2">
          ...
          <div>
            <Label className="text-base font-medium">
              Food & Entertainment VAT
            </Label>
            <p className="text-sm text-muted-foreground mt-1">
              VAT on food is only reclaimable when food is supplied to employees in a staff canteen 
              (free or subsidised). Entertainment expenses are never reclaimable.
            </p>
          </div>
        </div>
        ...
        <RadioGroup
          ...
          onValueChange={(v) => onUpdate({ food_vat_claim: v as "no" | "allowed_staff_canteen" | "not_allowed_exclude" })}
        ...
        {data.motor_vat_claim === "fuel_and_other" && (
          <div className="ml-7 space-y-3">
            <div className="p-3 bg-destructive/10 border border-destructive/20 rounded-lg text-sm">
              <strong>Warning:</strong> VAT on repairs, insurance, motor tax, tolls, and most motor costs 
              is not reclaimable on passenger vehicles. Would you like to remove non-allowed VAT from your claim?
            </div>
