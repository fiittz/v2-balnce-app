...
export const mccMappings: MCCMapping[] = [
  ...
  {
    code: 780,
    description: "Landscaping/Horticultural",
    category: "Materials",
    vat_type: "Standard 23%",
    vat_deductible: true,
    isTradeSupplier: true,
  ...
  {
    code: 1711,
    description: "Heating/Plumbing/AC Contractors",
    category: "Materials",
    vat_type: "Standard 23%",
    vat_deductible: true,
    isTradeSupplier: true,
  ...
  {
    code: 1740,
    description: "Masonry/Stonework/Tile",
    category: "Materials",
    vat_type: "Standard 23%",
    vat_deductible: true,
    isTradeSupplier: true,
  ...
  {
    code: 3351,
    description: "Car Rental (general)",
  ...
  {
    code: 4111,
    description: "Local Commuter Transport",
    category: "Motor/travel",
    vat_type: "Zero",
    vat_deductible: true,
  },
  ...
  {
    code: 4214,
    description: "Motor Freight/Delivery",
    category: "Office",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  ...
  {
    code: 4411,
    description: "Steamship/Cruise Lines",
    category: "Motor/travel",
    vat_type: "Zero",
    vat_deductible: true,
  },
  {
    code: 4457,
    description: "Boat Rental/Leasing",
    category: "Motor/travel",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  {
    code: 4468,
    description: "Marinas/Marine Service",
    category: "Motor/travel",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  ...
  {
    code: 4784,
    description: "Bridge and Road Tolls",
    category: "Motor/travel",
    vat_type: "Zero",
    vat_deductible: true,
  },
  ...
  {
    code: 4829,
    description: "Wire Transfers/Money Orders",
    category: "Bank fees",
    vat_type: "Exempt",
    vat_deductible: false,
  },
  ...
  {
    code: 5013,
    description: "Motor Vehicle Supplies/Parts (wholesale)",
    category: "Motor/travel",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  {
    code: 5021,
    description: "Office/Commercial Furniture",
    category: "Office",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  {
    code: 5039,
    description: "Construction Materials (wholesale)",
    category: "Materials",
    vat_type: "Standard 23%",
    vat_deductible: true,
    isTradeSupplier: true,
  ...
  {
    code: 5044,
    description: "Photographic/Copy/Fax Equipment",
    category: "Equipment",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  ...
  {
    code: 5047,
    description: "Medical/Dental/Ophthalmic Equipment",
    category: "Medical",
    vat_type: "Exempt",
    vat_deductible: false,
    relief_type: "medical",
  ...
  {
    code: 5051,
    description: "Metal Services/Wire Products",
    category: "Materials",
    vat_type: "Standard 23%",
    vat_deductible: true,
    isTradeSupplier: true,
  ...
  {
    code: 5072,
    description: "Hardware/Tools (wholesale)",
    category: "Tools",
    vat_type: "Standard 23%",
    vat_deductible: true,
    isTradeSupplier: true,
  ...
  {
    code: 5074,
    description: "Plumbing/Heating (wholesale)",
    category: "Materials",
    vat_type: "Standard 23%",
    vat_deductible: true,
    isTradeSupplier: true,
  ...
  {
    code: 5131,
    description: "Piece Goods/Fabrics",
    category: "Materials",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  {
    code: 5137,
    description: "Uniforms/Commercial Clothing",
    category: "Workwear",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  ...
  {
    code: 5169,
    description: "Chemicals (wholesale)",
    category: "Materials",
    vat_type: "Standard 23%",
    vat_deductible: true,
    isTradeSupplier: true,
  ...
  {
    code: 5172,
    description: "Petroleum/Petroleum Products",
    category: "General Expenses",
    vat_type: "Standard 23%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  {
    code: 5193,
    description: "Florists/Nursery Supplies",
    category: "Materials",
    vat_type: "Reduced 13.5%",
    vat_deductible: true,
  },
  ...
  {
    code: 5200,
    description: "Home Supply Warehouse",
    category: "Materials",
    vat_type: "Standard 23%",
    vat_deductible: true,
    isTradeSupplier: true,
  ...
  {
    code: 5231,
    description: "Glass/Paint/Wallpaper",
    category: "Materials",
    vat_type: "Standard 23%",
    vat_deductible: true,
    isTradeSupplier: true,
  ...
  {
    code: 5261,
    description: "Nurseries/Lawn/Garden Supplies",
    category: "Materials",
    vat_type: "Reduced 13.5%",
    vat_deductible: true,
  },
  ...
  {
    code: 5441,
    description: "Candy/Confectionery",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  ...
  {
    code: 5499,
    description: "Convenience Stores/Speciality Markets",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  {
    code: 5511,
    description: "Car/Truck Dealers (New/Used)",
  ...
  {
    code: 5521,
    description: "Car/Truck Dealers (Used)",
    category: "Motor Vehicle Expenses",
    vat_type: "Standard 23%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  {
    code: 5531,
    description: "Auto/Home Supply Stores",
    category: "Motor/travel",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  {
    code: 5532,
    description: "Automotive Tyre Stores",
  ...
  {
    code: 5611,
    description: "Men's/Boys' Clothing",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  ...
  {
    code: 5641,
    description: "Children's/Infants' Clothing",
    category: "Drawings",
    vat_type: "Zero",
    vat_deductible: false,
  },
  ...
  {
    code: 5655,
    description: "Sports/Riding Apparel",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  ...
  {
    code: 5691,
    description: "Men's/Women's Clothing",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  {
    code: 5699,
    description: "Clothing/Accessories (misc)",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  ...
  {
    code: 5714,
    description: "Drapery/Window Covering",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  {
    code: 5718,
    description: "Fireplace/Accessories",
    category: "Materials",
    vat_type: "Standard 23%",
    vat_deductible: true,
    isTradeSupplier: true,
  ...
  {
    code: 5719,
    description: "Miscellaneous Home Furnishings",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  {
    code: 5733,
    description: "Music Stores/Instruments",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  ...
  {
    code: 5813,
    description: "Bars/Cocktail Lounges/Pubs",
    category: "Meals & Entertainment",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  ...
  {
    code: 5921,
    description: "Package Stores (Beer/Wine/Liquor)",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  {
    code: 5931,
    description: "Used Merchandise/Second-Hand",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  {
    code: 5944,
    description: "Jewelry Stores/Watches",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  {
    code: 5945,
    description: "Hobby/Toy/Game Shops",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  {
    code: 5946,
    description: "Camera/Photographic Supplies",
    category: "Equipment",
    vat_type: "Standard 23%",
    vat_deductible: true,
    needs_receipt: true,
  ...
  {
    code: 5947,
    description: "Gift/Card/Novelty Shops",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  {
    code: 5948,
    description: "Luggage/Leather Goods",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  {
    code: 5970,
    description: "Artist Supply/Craft Stores",
    category: "Materials",
    vat_type: "Standard 23%",
    vat_deductible: true,
    needs_receipt: true,
  ...
  {
    code: 5971,
    description: "Art Dealers/Galleries",
    category: "Drawings",
    vat_type: "Reduced 13.5%",
    vat_deductible: false,
  },
  ...
  {
    code: 5993,
    description: "Cigar Stores/Tobacconists",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  ...
  {
    code: 5999,
    description: "Miscellaneous/Speciality Retail",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  {
    code: 6010,
    description: "Financial Institutions (Manual Cash)",
    category: "Bank fees",
    vat_type: "Exempt",
    vat_deductible: false,
  },
  ...
  {
    code: 6513,
    description: "Real Estate Agents/Rentals",
    category: "Rent",
    vat_type: "Exempt",
    vat_deductible: false,
  },
  ...
  {
    code: 7011,
    description: "Lodging (Hotels/Motels)",
    category: "Subsistence",
    vat_type: "Reduced 13.5%",
    vat_deductible: false,
  },
  ...
  {
    code: 7230,
    description: "Beauty/Barber Shops",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  ...
  {
    code: 7273,
    description: "Dating/Escort Services",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  ...
  {
    code: 7278,
    description: "Buying/Shopping Services",
    category: "other",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  ...
  {
    code: 7333,
    description: "Commercial Photography/Graphics",
    category: "Marketing",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  {
    code: 7338,
    description: "Quick Copy/Reproduction",
    category: "Office",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  {
    code: 7339,
    description: "Stenographic/Secretarial Services",
    category: "Office",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  {
    code: 7342,
    description: "Exterminating/Disinfecting",
    category: "Repairs and Maintenance",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  {
    code: 7349,
    description: "Cleaning/Maintenance/Janitorial",
    category: "Cleaning",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  {
    code: 7361,
    description: "Employment Agencies/Temp Help",
    category: "Wages",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  ...
  {
    code: 7393,
    description: "Detective/Protective/Security",
    category: "General Expenses",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  {
    code: 7394,
    description: "Equipment Rental/Leasing",
    category: "Equipment",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  ...
  {
    code: 7399,
    description: "Business Services (miscellaneous)",
    category: "other",
    vat_type: "Standard 23%",
    vat_deductible: true,
    needs_receipt: true,
  ...
  {
    code: 7531,
    description: "Automotive Body Repair",
    category: "Repairs and Maintenance",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  {
    code: 7534,
    description: "Tire Retreading/Repair",
    category: "Repairs and Maintenance",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  ...
  {
    code: 7801,
    description: "Government Licensed Online Casinos",
    category: "Drawings",
    vat_type: "Exempt",
    vat_deductible: false,
  },
  ...
  {
    code: 7911,
    description: "Dance Halls/Studios/Schools",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  ...
  {
    code: 7941,
    description: "Sports Clubs/Fields",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  {
    code: 7991,
    description: "Tourist Attractions/Exhibits",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  ...
  {
    code: 7993,
    description: "Video Amusement Game",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  ...
  {
    code: 7995,
    description: "Betting (including Lottery)",
    category: "Drawings",
    vat_type: "Exempt",
    vat_deductible: false,
  },
  ...
  {
    code: 7997,
    description: "Membership Clubs (Country/Athletic)",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  {
    code: 7998,
    description: "Aquariums/Seaquariums",
    category: "Drawings",
    vat_type: "Standard 23%",
    vat_deductible: false,
  },
  ...
  {
    code: 8043,
    description: "Opticians/Optical Goods",
    category: "Medical",
    vat_type: "Exempt",
    vat_deductible: false,
    relief_type: "medical",
  ...
  {
    code: 8049,
    description: "Podiatrists/Chiropodists",
    category: "Medical",
    vat_type: "Exempt",
    vat_deductible: false,
    relief_type: "medical",
  ...
  {
    code: 8050,
    description: "Nursing/Personal Care Facilities",
    category: "Medical",
    vat_type: "Exempt",
    vat_deductible: false,
    relief_type: "medical",
  ...
  {
    code: 8099,
    description: "Medical Services (misc)",
    category: "Medical",
    vat_type: "Exempt",
    vat_deductible: false,
    relief_type: "medical",
  ...
  {
    code: 8211,
    description: "Schools (Elementary/Secondary)",
    category: "other",
    vat_type: "Exempt",
    vat_deductible: false,
    relief_type: "tuition",
  ...
  {
    code: 8299,
    description: "Schools/Educational Services (misc)",
    category: "Training",
    vat_type: "Exempt",
    vat_deductible: false,
  },
  ...
  {
    code: 8911,
    description: "Architectural/Engineering Services",
    category: "Consulting & Accounting",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  ...
  {
    code: 8999,
    description: "Professional Services (misc)",
    category: "Consulting & Accounting",
    vat_type: "Standard 23%",
    vat_deductible: true,
  },
  ...
  {
    code: 9399,
    description: "Government Services (misc)",
    category: "Consulting & Accounting",
    vat_type: "Exempt",
    vat_deductible: false,
  },
  ...
  {
    code: 9405,
    description: "Intra-Government Purchases",
    category: "other",
    vat_type: "Exempt",
    vat_deductible: false,
  },
