...
export const vendorDatabase: VendorEntry[] = [
  ...
  {
    name: "Baseline.comm",
    patterns: ["baseline.comm", "baseline comm", "baselinecomm"],
    category: "Rent",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Co-working / office space rental. VAT deductible under Section 59.",
    sector: "property",
  },
  {
    name: "WeWork",
    patterns: ["wework", "we work"],
    category: "Rent",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Co-working / office space rental. VAT deductible under Section 59.",
  ...
  },
  {
    ...
    patterns: ["regus", "spaces iwg", "iwg plc", "iwg office"],
    category: "Rent",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Serviced office / co-working rental. VAT deductible under Section 59.",
    sector: "property",
  },
  {
    name: "Iconic Offices",
    patterns: ["iconic offices", "iconic office"],
    category: "Rent",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Premium co-working / office space rental. VAT deductible under Section 59.",
    sector: "property",
  },
  {
    name: "Dogpatch Labs",
    patterns: ["dogpatch labs", "dogpatch"],
    category: "Rent",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Startup co-working / office space rental. VAT deductible under Section 59.",
    sector: "property",
  },
  {
    name: "The Tara Building",
    patterns: ["tara building", "the tara building"],
    category: "Rent",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Co-working / office space rental. VAT deductible under Section 59.",
  ...
  {
    name: "NovaUCD",
    patterns: ["novaucd", "nova ucd"],
    category: "Rent",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "University incubator / office space rental. VAT deductible under Section 59.",
    sector: "property",
  },

  // ────────────────────────────────────────────────────────────
  // EU AIRLINES & TRANSPORT
  // ────────────────────────────────────────────────────────────
  {
    name: "Lufthansa",
    patterns: ["lufthansa"],
    ...
    vat_type: "Zero",
    vat_deductible: true,
    purpose: "International air travel. Zero-rated for VAT (passenger transport).",
    sector: "transport",
  },
  {
    name: "KLM / Air France",
    patterns: ["klm", "air france", "airfrance"],
    category: "Motor/travel",
    vat_type: "Zero",
    vat_deductible: true,
    purpose: "International air travel. Zero-rated for VAT (passenger transport).",
  ...
  {
    name: "Flixbus",
    patterns: ["flixbus", "flix bus"],
    category: "Motor/travel",
    vat_type: "Zero",
    vat_deductible: true,
    purpose: "International bus travel. Zero-rated for VAT (passenger transport).",
    sector: "transport",
  },
  {
    name: "Brittany Ferries",
    patterns: ["brittany ferries", "brittany ferry"],
    category: "Motor/travel",
    vat_type: "Zero",
    vat_deductible: true,
    purpose: "International ferry travel. Zero-rated for VAT (passenger transport).",
    sector: "transport",
  },
  {
    name: "Eurostar",
    ...
    vat_type: "Zero",
    vat_deductible: true,
    purpose: "International rail travel. Zero-rated for VAT (passenger transport).",
    sector: "transport",
  },
  {
    name: "Emirates / Etihad / Qatar Airways",
    patterns: ["emirates", "etihad", "qatar airways"],
    category: "Motor/travel",
    vat_type: "Zero",
    vat_deductible: true,
    purpose: "International air travel. Zero-rated for VAT (passenger transport).",
  ...
  },
  {
    ...
    patterns: ["turkish airlines", "thy turkish"],
    category: "Motor/travel",
    vat_type: "Zero",
    vat_deductible: true,
    purpose: "International air travel. Zero-rated for VAT (passenger transport).",
  ...
  {
    name: "Norwegian Air",
    patterns: ["norwegian air", "norwegian shuttle"],
    category: "Motor/travel",
    vat_type: "Zero",
    vat_deductible: true,
    purpose: "International air travel. Zero-rated for VAT (passenger transport).",
  ...
  // ────────────────────────────────────────────────────────────
  // EU HOTELS — Cost deductible for CT. VAT not reclaimable EXCEPT for conference accommodation
  // ────────────────────────────────────────────────────────────
  {
    name: "Premier Inn",
    patterns: ["premier inn"],
    category: "Subsistence",
    vat_type: "Reduced 13.5%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  {
    name: "Travelodge",
    patterns: ["travelodge", "travel lodge"],
    category: "Subsistence",
    vat_type: "Reduced 13.5%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  {
    name: "Jurys Inn / Leonardo Hotels",
    patterns: ["jurys inn", "jurys hotel", "leonardo hotel", "leonardo hotels"],
    category: "Subsistence",
    vat_type: "Reduced 13.5%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  {
    name: "Clayton Hotels",
    patterns: ["clayton hotel", "clayton hotels"],
    category: "Subsistence",
    vat_type: "Reduced 13.5%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  {
    name: "Maldron Hotels",
    patterns: ["maldron hotel", "maldron hotels"],
    category: "Subsistence",
    vat_type: "Reduced 13.5%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  },
  {
    ...
    patterns: ["holiday inn", "ihg hotel", "ihg hotels", "intercontinental"],
    category: "Subsistence",
    vat_type: "Reduced 13.5%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  {
    name: "Hilton",
    patterns: ["hilton hotel", "hilton hotels", "hilton garden"],
    category: "Subsistence",
    vat_type: "Reduced 13.5%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  {
    name: "Marriott",
    patterns: ["marriott", "courtyard marriott", "marriott hotel"],
    category: "Subsistence",
    vat_type: "Reduced 13.5%",
    vat_deductible: false,
    needs_receipt: true,
  ...
  // ────────────────────────────────────────────────────────────
  // EU/INTERNATIONAL CLOUD & SAAS
  // ────────────────────────────────────────────────────────────
  {
    name: "OVHcloud",
    patterns: ["ovhcloud", "ovh cloud", "ovh.com"],
    category: "Cloud Hosting",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Cloud hosting/infrastructure. VAT deductible under Section 59.",
    isTechSupplier: true,
    sector: "software",
  },
  {
  ...
  },
  {
    ...
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Cloud database/backend-as-a-service. VAT deductible under Section 59.",
    isTechSupplier: true,
    sector: "software",
  },
  {
    name: "MongoDB Atlas",
    patterns: ["mongodb", "mongodb atlas", "mongo atlas"],
    category: "Cloud Hosting",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Cloud database hosting. VAT deductible under Section 59.",
    isTechSupplier: true,
    sector: "software",
  },
  {
    name: "Railway",
    patterns: ["railway.app", "railway app"],
    category: "Cloud Hosting",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Cloud hosting/deployment platform. VAT deductible under Section 59.",
    isTechSupplier: true,
    sector: "software",
  },
  {
    name: "Render",
    patterns: ["render.com", "render cloud"],
    category: "Cloud Hosting",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Cloud hosting/deployment platform. VAT deductible under Section 59.",
  ...
  },
  {
    ...
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Cloud monitoring/observability platform. VAT deductible under Section 59.",
    isTechSupplier: true,
    sector: "software",
  },
  {
    name: "SAP / Concur",
    patterns: ["sap concur", "concur", "sap.com", "sap se"],
    category: "Software",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Enterprise software / expense management. VAT deductible under Section 59.",
    isTechSupplier: true,
    sector: "software",
  },
  // ────────────────────────────────────────────────────────────
  // EU FINTECH / PAYMENT PROCESSING
  // ────────────────────────────────────────────────────────────
  {
    name: "Klarna",
    patterns: ["klarna"],
    ...
    vat_type: "Exempt",
    vat_deductible: false,
    purpose: "Payment/BNPL service. Financial services are VAT exempt.",
    sector: "fintech",
  },
  {
    name: "Mollie",
    patterns: ["mollie", "mollie payments"],
    category: "Payment Processing",
    vat_type: "Exempt",
    vat_deductible: false,
    purpose: "Payment processing. Financial services are VAT exempt.",
    sector: "fintech",
  },
  {
    name: "GoCardless",
    patterns: ["gocardless", "go cardless"],
    category: "Payment Processing",
    vat_type: "Exempt",
    vat_deductible: false,
    purpose: "Direct debit payment processing. Financial services are VAT exempt.",
    sector: "fintech",
  },
  {
    name: "Adyen",
    ...
    vat_type: "Exempt",
    vat_deductible: false,
    purpose: "Payment processing platform. Financial services are VAT exempt.",
    sector: "fintech",
  },
  ...
  // ────────────────────────────────────────────────────────────
  {
    ...
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Freelance/consulting platform fees. VAT deductible under Section 59.",
    sector: "professional",
  },
  {
    name: "Toptal",
  ...
  {
    name: "PeoplePerHour",
    patterns: ["peopleperhour", "people per hour"],
    category: "Consulting & Accounting",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Freelance/consulting platform fees. VAT deductible under Section 59.",
  ...
  // ────────────────────────────────────────────────────────────
  {
    ...
    patterns: ["aliexpress", "alibaba", "ali express"],
    category: "Purchases",
    vat_type: "Standard 23%",
    vat_deductible: true,
    needs_receipt: true,
    purpose: "Online marketplace purchase. Receipt required to verify business use. VAT deductible with valid invoice.",
    sector: "retail",
  },
  {
    name: "Zalando",
  ...
  {
    name: "eBay",
    patterns: ["ebay", "ebay.ie", "ebay.co.uk"],
    category: "General Expenses",
    vat_type: "Standard 23%",
    vat_deductible: true,
    needs_receipt: true,
    purpose: "Online marketplace. Receipt required to determine business use. VAT deductible with valid invoice.",
    sector: "retail",
  },
  ...
  {
    name: "TNT Express",
    patterns: ["tnt express", "tnt courier"],
    category: "Office",
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Courier/shipping service. VAT deductible under Section 59.",
    sector: "office",
  },
  {
    name: "Royal Mail",
    ...
    vat_type: "Standard 23%",
    vat_deductible: true,
    purpose: "Postal/courier service. VAT deductible under Section 59.",
    sector: "office",
  },
];
