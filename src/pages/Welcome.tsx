    ...
    <div className="min-h-screen bg-primary flex flex-col">
      {screen === "welcome" && (
        <div className="flex-1 flex flex-col items-center justify-center px-6 animate-fade-in">
          <div className="mb-8">
            <PenguinIcon className="w-24 h-24 text-foreground" />
          </div>
          <h1 className="text-5xl font-bold text-foreground tracking-tight mb-4">BALNCE</h1>
          <p className="text-foreground/80 font-serif text-xl mb-12">Your Accounting</p>
          
          <div className="w-full max-w-sm space-y-4">
            <Button 
              onClick={() => setScreen("signup")}
              className="w-full h-14 bg-foreground text-background hover:bg-foreground/90 text-lg font-semibold rounded-xl"
            >
              Sign Up
            </Button>
            <Button 
              ...
              variant="outline"
              className="w-full h-14 bg-transparent border-2 border-foreground text-foreground hover:bg-foreground/10 text-lg font-semibold rounded-xl"
            >
              Log In
            </Button>
            <Button 
              ...
              variant="ghost"
              className="w-full h-12 text-foreground/70 hover:text-foreground hover:bg-foreground/10 text-base font-medium rounded-xl flex items-center justify-center gap-2"
            >
      ...
      {screen === "login" && (
        <div className="flex-1 flex flex-col px-6 py-8 animate-fade-in">
          <button 
            ...
            className="text-foreground mb-8 self-start font-medium"
          >
            ← Back
          </button>
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }} className="space-y-5">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  className="h-14 bg-background/10 border-foreground/20 text-foreground placeholder:text-foreground/50 rounded-xl text-lg"
                  autoComplete="email"
                />
              </div>
              <div className="space-y-2">
              ...
              <Button 
                type="submit"
                disabled={isLoading}
                className="w-full h-14 bg-foreground text-background hover:bg-foreground/90 text-lg font-semibold rounded-xl mt-6"
              >
      ...
      {screen === "business-type" && (
        <div className="flex-1 flex flex-col px-6 py-8 animate-fade-in">
          <button 
            onClick={() => setScreen("signup")} 
            className="text-foreground mb-6 self-start font-medium"
          >
            ← Back
          </button>
            ...
            <div className="space-y-5">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  autoFocus
                />
                <p className="text-foreground/60 text-sm">This helps us tailor your experience</p>
              </div>
              
              <Button 
                onClick={handleContinue}
                disabled={!industryType.trim() || isLoading}
                className="w-full h-14 bg-foreground text-background hover:bg-foreground/90 text-lg font-semibold rounded-xl disabled:opacity-50 mt-6"
              >
